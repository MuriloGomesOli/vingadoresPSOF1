...
CREATE TABLE `prisao` (
  `idprisao` int NOT NULL AUTO_INCREMENT,
  `idheroi` int DEFAULT NULL,
  `motivo` varchar(255) DEFAULT NULL,
  `data` datetime DEFAULT NULL,
  PRIMARY KEY (`idprisao`),
  KEY `fk_prisao_hero_idx` (`idheroi`),
  CONSTRAINT `fk_prisao_hero` FOREIGN KEY (`idheroi`) REFERENCES `heroi` (`idheroi`)
